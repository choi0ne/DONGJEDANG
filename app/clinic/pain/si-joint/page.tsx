...
export default function SIJoint() {
    return (
            ...
            <main>
                <section className="relative py-20 bg-[#FDFBF7]">
                    <div className="max-w-[1200px] mx-auto px-6 text-center">
                        <span className="block text-primary font-bold tracking-[0.3em] uppercase mb-4 animate-fadeIn">Sacroiliac Joint Pain</span>
                    ...
                    <div className="max-w-[1000px] mx-auto px-6 prose max-w-none">
                        <div className="text-center mb-12">
                            ...
                            <p className="text-text/80">
                                천장관절의 염증을 줄이고 주변 근육과 인대를 강화하여<br />
                                골반의 안정성을 높이고 통증을 완화합니다.
                            </p>
                        </div>
                    </div>
                </section>
