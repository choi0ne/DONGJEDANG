            ...
            <main>
                <section className="relative py-20 bg-[#FDFBF7]">
                    <div className="max-w-[1200px] mx-auto px-6 text-center">
                        <span className="block text-primary font-bold tracking-[0.3em] uppercase mb-4 animate-fadeIn">Thoracic Outlet Syndrome</span>
                    ...
                    <div className="max-w-[1000px] mx-auto px-6 prose max-w-none">
                        <div className="text-center mb-12">
                            ...
                            <p className="text-text/80">
                                굳어진 목과 어깨 근육을 이완시키고 체형을 교정하여<br />
                                신경 압박을 해소하고 통증을 치료합니다.
                            </p>
                        </div>
                    </div>
                </section>
