            ...
            <main>
                <section className="relative py-20 bg-[#FDFBF7]">
                    <div className="max-w-[1200px] mx-auto px-6 text-center">
                        <span className="block text-primary font-bold tracking-[0.3em] uppercase mb-4 animate-fadeIn">Irritable Bowel Syndrome</span>
                    ...
                    <div className="max-w-[1000px] mx-auto px-6 prose max-w-none">
                        <div className="text-center mb-12">
                            ...
                            <p className="text-text/80">
                                스트레스와 잘못된 식습관으로 예민해진 대장을 진정시키고,<br />
                                자율신경의 균형을 맞춰 배변 활동을 정상화합니다.
                            </p>
                        </div>
                    </div>
                </section>
