            ...
            <main>
                <section className="relative py-20 bg-[#FDFBF7]">
                    <div className="max-w-[1200px] mx-auto px-6 text-center">
                        <span className="block text-primary font-bold tracking-[0.3em] uppercase mb-4 animate-fadeIn">Rhinitis</span>
                    ...
                    <div className="max-w-[1000px] mx-auto px-6 prose max-w-none">
                        <div className="text-center mb-12">
                            ...
                            <p className="text-text/80">
                                만성적인 코막힘과 콧물을 근본적으로 치료하고,<br />
                                폐와 기관지의 면역력을 강화하여 재발을 막습니다.
                            </p>
                        </div>
                    </div>
                </section>
