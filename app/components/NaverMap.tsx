...
export default function NaverMap() {
    ...
    const initMap = () => {
        ...
        // Ensure Service is available (it should be if submodules=geocoder is loaded)
        if (window.naver.maps.Service) {
            ...
            console.error("Naver Maps Service (Geocoder) not loaded.");
        }
    };
    ...
    return (
        <>
            <Script
                ...
                src="https://oapi.map.naver.com/openapi/v3/maps.js?ncpClientId=azvkoqysoc&submodules=geocoder"
                onLoad={initMap}
            />
            <div
                ref={mapRef}
