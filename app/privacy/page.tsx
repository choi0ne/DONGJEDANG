        ...
        <div className="min-h-screen bg-background text-text font-sans">
            ...
            <main className="max-w-[1000px] mx-auto px-6 py-20">
                <div className="text-center mb-16">
                    <h1 className="text-3xl md:text-4xl font-bold mb-6 font-serif text-text">
                        개인정보처리방침
                    </h1>
                    <div className="w-16 h-1 bg-primary/30 mx-auto"></div>
                </div>

                <div className="bg-white p-8 md:p-12 rounded-2xl shadow-sm border border-secondary/10 prose max-w-none prose-headings:font-serif prose-headings:text-primary prose-p:text-text/80 prose-strong:text-text">

                    <p>
                        동제당한의원(이하 회사)는 개인정보보호법에 따라 이용자의 개인정보 보호 및 권익을 보호하고 개인정보와 관련한 이용자의 고충을 원활하게 처리할 수 있도록 다음과 같은 처리방침을 두고 있습니다.
                    </p>
                    <p>
                    ...
                    <p><strong>가. 홈페이지 회원가입 및 관리</strong><br />
                        회원 가입의사 확인, 회원제 서비스 제공에 따른 본인 식별·인증, 회원자격 유지·관리, 제한적 본인확인제 시행에 따른 본인확인, 서비스 부정이용 방지, 각종 고지·통지, 고충처리, 분쟁 조정을 위한 기록 보존 등을 목적으로 개인정보를 처리합니다.</p>
                    <p><strong>나. 민원사무 처리</strong><br />
                        민원인의 신원 확인, 민원사항 확인, 사실조사를 위한 연락·통지, 처리결과 통보 등을 목적으로 개인정보를 처리합니다.</p>
                    <p><strong>다. 재화 또는 서비스 제공</strong><br />
                        물품배송, 서비스 제공, 청구서 발송, 콘텐츠 제공, 맞춤 서비스 제공, 본인인증, 연령인증, 요금결제·정산 등을 목적으로 개인정보를 처리합니다.</p>
                    <p><strong>라. 마케팅 및 광고에의 활용</strong><br />
                    ...
                    <p>가. 회원 가입 시 수집항목<br />
                        - 필수항목 : 이름, 성별, 로그인ID, 비밀번호, 이메일, 생년월일, 주소, 휴대폰번호<br />
                        - 선택항목 : 자택번호, SMS 수신동의, 이메일 수신동의<br />
                        - 수집목적 : 회원특정 및 고지사항 전달, 본인의사 확인 및 불만처리 등 원활한 의사소통 경로의 확보</p>
                    <p>나. 상품구매 시 수집항목<br />
                        - 주문고객정보 : 주문자 이름, 이메일주소, 휴대폰번호, 전화번호, 주소지, 배송시 요청사항<br />
                        - 배송지정보: 수령인 이름, 휴대폰번호, 전화번호, 주소, 배송지 요구사항<br />
                        - 결제정보 : 결제를 진행하기 위해 필요한 결제 관련 정보 (신용카드, 결제 계좌정보)</p>
                    <p>다. 자동 수집<br />
                        - 결제기록, 접속 IP 정보, 쿠키, 서비스 이용 기록, 접속로그 등</p>
                    <p>라. 기타 (이벤트나 마케팅 활동 등)<br />
                        - 수집정보 : 주소, 생년월일, 전화번호, 휴대폰번호, 이름, 이메일 등<br />
                        - 그 외 특정 목적을 위해 단기적으로 개인정보를 수집할 경우에는 별도로 공지하고 수집합니다.</p>

                    <p><strong>② 수집 방법</strong></p>
                    <p>다음과 같은 방법으로 개인정보를 수집합니다.<br />
                        - 홈페이지(회원가입), 서면양식, 전화, 팩스, 상담게시판, 이벤트응모, 배송요청(비회원 구매 포함), 서비스이용, 회원정보 수정<br />
                        - 제휴회사로부터의 제공</p>
                    ...
                    <ul className="list-disc pl-5 space-y-1">
                        ...
                        <li>배송정보 : 재화 또는 용역 등 상품이 인도되거나 제공된 때</li>
                    ...
                    <ul className="list-disc pl-5 space-y-1">
                        ...
                        <li>계약 이행을 위해 필요한 경우(제품 배송/설치, 서비스 업무)</li>
                        ...
                        <li>기타 관련 법령의 규정에 의하거나, 수사 목적으로 법령에 정해진 절차와 방법에 따라 수사기관의 요구가 있는 경우.</li>
